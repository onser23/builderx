...
import MaterialBasicFooter from './src/components/MaterialBasicFooter';
...
const App = () => {
  return (
    <View style={styles.container}>
        ...
        <View style={styles.rect}>
          ...
          <View style={styles.imageRow}>
            ...
            <View style={styles.helloColumn}>
              ...
              <Text style={styles.mestanMestanov}>Mestan Mestanli</Text>
            </View>
      ...
      <MaterialBasicFooter
        style={styles.materialBasicFooter}></MaterialBasicFooter>
      <View style={styles.rect11}>
        <View style={styles.support3Row}>
          <Text style={styles.support3}>Support</Text>
          <IoniconsIcon
            name="ios-arrow-forward"
            style={styles.icon8}></IoniconsIcon>
        </View>
      </View>
